...
const tabs: TabItem[] = [
  { label: 'Barcha tovarlar', count: 0 },
  { label: 'Sotuvdagi', count: 13 },
  { label: 'Tugayapti', count: 2 },
  { label: "Sotuvda bo'lmaganlar", count: 6 },
  { label: 'Bloklanganlar', count: 0 },
  { label: 'Arxivdagilar', count: 4 },
  { label: "Xususiyati to'ldirilmagan", count: 0 },
];
