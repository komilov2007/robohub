...
export const TopBar = styled(Box)<CollapsedProps>(({ collapsed }) => ({
  position: "fixed",
  top: 0,
  left: collapsed ? "50px" : "252px",
  width: collapsed ? "calc(100% - 50px)" : "calc(100% - 252px)",
  height: "74px",
  display: "flex",
  alignItems: "center",
...
export const MarketplaceBadge = styled(Box)<{ tone?: "link" | "share" }>(
  ({ tone }) => ({
    height: "18px",
    padding: "0 6px",
    borderRadius: "999px",
