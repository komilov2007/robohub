...
export const TabText = styled(Typography)<{ active?: boolean }>(({ active }) => ({
  fontSize: '14px',
  lineHeight: '18px',
  fontFamily:'inter',
...
export const PageButton = styled(IconButton)<{ active?: boolean }>(({ active }) => ({
  width: 28,
  height: 28,
  borderRadius: 8,
...
export const PageTextButton = styled(Box)<{ active?: boolean }>(({ active }) => ({
  minWidth: 28,
  height: 28,
  padding: '0 6px',
  borderRadius: 8,
